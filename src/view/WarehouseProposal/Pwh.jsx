  ...
  agreement_period_month: yup.number().when("lock_in_period", {
    ...
    then: () =>
      yup
        .number()
        .min(
          yup.ref("lock_in_period_month"),
          "Agreement period month must be greater than or equal to Lock-in period month"
        )
        .min(0, "Agreement period month cannot be negative") // Added this validation
                                ...
                                <>
                                  ...
                                  <GridItem>
                                    ...
                                    <Input
                                      ...
                                      style={inputStyle}
                                      borderColor={
                                        clientError.endDate ? "red" : "gray.10"
                                      }
                                    />
                                  </GridItem>
                                  <GridItem>
                                    ...
                                    <ReactSelect
                                      ...
                                      value={
                                        clientBillingCycle?.filter(
                                          (item) =>
                                            item.value === clientList.resBilling
                                        )[0] || {}
                                      }
                                      isLoading={false}
                                      onChange={(val) => {
                                        ...
                                        ClientSelectOnChange(val, "resBilling");
                                      }}
                                      styles={{
                                        control: (base, state) => ({
                                          ...base,
                                          backgroundColor: "#fff",
                                          borderRadius: "6px",
                                          borderColor: clientError.resBilling
                                            ? "red"
                                            : "#c3c3c3",
                                    ...
                                    <ReactSelect
                                      ...
                                      styles={{
                                        control: (base, state) => ({
                                          ...
                                          backgroundColor: "#fff",
                                          borderRadius: "6px",
                                          borderColor: clientError.postBilling
                                            ? "red"
                                            : "#c3c3c3",
